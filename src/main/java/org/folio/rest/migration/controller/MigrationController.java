...
public class MigrationController {
  ...
  public CompletableFuture<String> userReferenceLinks(@RequestBody UserReferenceLinkContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> users(@RequestBody UserContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> vendorReferenceLinks(@RequestBody VendorReferenceLinkContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> vendors(@RequestBody VendorContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> inventoryReferenceLinks(@RequestBody InventoryReferenceLinkContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> bibs(@RequestBody BibContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> holdings(@RequestBody HoldingsContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> items(@RequestBody ItemContext context, @TenantHeader String tenant) throws MigrationException {
    return migrationService.migrate(ItemMigration.with(context, tenant));
  }

  @PostMapping("/requests")
  public CompletableFuture<String> requests(@RequestBody RequestContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> loans(@RequestBody LoanContext context, @TenantHeader String tenant) throws MigrationException {
  ...
  public CompletableFuture<String> feesfines(@RequestBody FeeFineContext context, @TenantHeader String tenant) throws MigrationException {
    return migrationService.migrate(FeeFineMigration.with(context, tenant));
  }

  @PostMapping("/proxyfor")
  public CompletableFuture<String> proxyfor(@RequestBody ProxyForContext context, @TenantHeader String tenant) throws MigrationException {
    return migrationService.migrate(ProxyForMigration.with(context, tenant));
  }

  @PostMapping("/boundwith")
  public CompletableFuture<String> boundwith(@RequestBody BoundWithContext context, @TenantHeader String tenant) throws MigrationException {
    return migrationService.migrate(BoundWithMigration.with(context, tenant));
  }

  @PostMapping("/divitpatron")
  public CompletableFuture<String> divitpatron(@RequestBody DivITPatronContext context, @TenantHeader String tenant) throws MigrationException {
