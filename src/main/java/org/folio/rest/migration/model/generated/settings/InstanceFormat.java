...
public class InstanceFormat {
     ...
     */
    @JsonProperty("name")
    @JsonPropertyDescription("label for the Instance format")
    private String name;
    /**
     ...
     */
    @JsonProperty("code")
    @JsonPropertyDescription("distinct code for the Instance format")
    private String code;
    /**
     ...
     */
    @JsonProperty("source")
    @JsonPropertyDescription("origin of the Instance format record")
    ...
    public String toString() {
        ...
        sb.append(InstanceFormat.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InstanceFormat) == false) {
            return false;
        }
        InstanceFormat rhs = ((InstanceFormat) other);
