...
public class IdentifierType {
     ...
     */
    @JsonProperty("name")
    @JsonPropertyDescription("label for the identifier type")
    private String name;
    /**
     ...
     */
    @JsonProperty("source")
    @JsonPropertyDescription("label indicating where the identifier type entry originates from, i.e. 'folio' or 'local'")
