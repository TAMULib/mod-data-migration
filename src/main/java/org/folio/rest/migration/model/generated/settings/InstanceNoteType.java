...
public class InstanceNoteType {
     ...
     */
    @JsonProperty("name")
    @JsonPropertyDescription("name of the Instance note type")
    private String name;
    /**
     ...
     */
    @JsonProperty("source")
    @JsonPropertyDescription("label indicating where the Instance note type entry originates from, i.e. 'folio' or 'local'")
    ...
    public String toString() {
        ...
        sb.append(InstanceNoteType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InstanceNoteType) == false) {
            return false;
        }
        InstanceNoteType rhs = ((InstanceNoteType) other);
