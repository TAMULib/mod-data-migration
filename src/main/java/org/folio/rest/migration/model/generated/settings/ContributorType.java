...
public class ContributorType {
     ...
     */
    @JsonProperty("name")
    @JsonPropertyDescription("label for the contributor type")
    private String name;
    /**
     ...
     */
    @JsonProperty("code")
    @JsonPropertyDescription("distinct code for the contributor type")
    private String code;
    /**
     ...
     */
    @JsonProperty("source")
    @JsonPropertyDescription("origin of the contributor type record")
    ...
    public String toString() {
        ...
        sb.append(ContributorType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ContributorType) == false) {
            return false;
        }
        ContributorType rhs = ((ContributorType) other);
