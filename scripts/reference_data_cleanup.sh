...
select '/data-import-profiles/mappingProfiles/' || id from diku_mod_data_import_converter_storage.mapping_profiles where id not in ('d0ebbc2e-2f0f-11eb-adc1-0242ac120002', '862000b9-84ea-4cae-a223-5fc0552f2b42', 'f90864ef-8030-480f-a43f-8cdd21233252');
EOM
